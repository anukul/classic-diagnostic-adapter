...
use cda_interfaces::{
    ...
    communication_control::{
        CommunicationInitMode, CommunicationLifecycle, PostUpdateCommunicationMode,
...
impl<SP: SecurityPlugin> CommunicationLifecycle for VariantDetectionInitializer<SP> {
    ...
    CPB: CommunicationPluginBuilder,
{
    ...
    plugin
        .register_lifecycle_hook(Arc::new(VariantDetectionInitializer {
