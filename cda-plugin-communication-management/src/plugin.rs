...
use cda_interfaces::communication_control::{CommunicationInitMode, CommunicationLifecycle};
...
pub trait CommunicationPlugin: cda_interfaces::Shutdown {
    ...
    /// Registers framework-enforced lifecycle hook (initialization and deinitialization).
