...
///
/// Acquiring this lease disables the transport and prevents other lifecycle
/// operations from activating communication.
///
/// Finish with one of two deliberately different outcomes:
///
/// * **[`release().await`](Self::release)** resumes communication immediately.
///   It awaits transport enablement and post-activation initialization, returning
///   `Enabled` on success or an activation failure.
///
