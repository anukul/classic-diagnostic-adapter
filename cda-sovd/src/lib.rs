...
use cda_plugin_communication_management::{
    http_protection::config::HttpRouteMatcher, lifecycle::access::CommunicationAccess,
};
...
pub use crate::sovd::{
    ...
    locks::Locks,
    request_guard::{HttpRestrictionLayer, HttpRestrictionService, install_http_restriction_guard},
