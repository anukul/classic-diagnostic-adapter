...
use cda_plugin_communication_management::http_protection::{
    config::HttpProtectionReason,
...
/// - [`HttpProtectionReason::Custom`] uses [`ErrorCode::VendorSpecific`] with
///   [`VendorErrorCode::CommunicationNotReady`] as the vendor code.
